...
>*Answer 1:*
NDVI measures the density of the green patch of land. As vegetation in fynbos gets larger and thicker, the satelites can only measure the space in between and not how large/tall. So if before maturity the space between plants fills out, the satelite will saturate.
<br>
...
>*Answer 3:*
Model 2 is better, because it significant and has a p-value<0.05.

Q4: How many degrees of freedom are there in this ANOVA and why (i.e. what are they)?

>*Answer 4:*
2. Its from the groups been tested.
<br>
...
>*Answer 5:*
fit_negexpS is preffered, because it has the lower AIC.
<br>
...
>*Answer 6:*
Models not fitted to the same data, changes their response. AIC cannot be computed by models fitted with maximam likelihood.
<br>